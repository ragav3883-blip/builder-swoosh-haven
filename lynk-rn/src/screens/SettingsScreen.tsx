    ...
    >
        ...
        >
          <Image
            source={{
              uri:
                state.user.photoURL ||
                "https://placehold.co/60x60/e2e8f0/e2e8f0",
            }}
            style={{
              width: 56,
              height: 56,
      ...
      {state.isLoggedIn && (
        <>
          ...
          <Pressable
            onPress={() => dispatch({ type: "SET_LANG", lang: "en" })}
            style={{
              backgroundColor: "#F3F4F6",
              padding: 14,
              borderRadius: 10,
          ...
          <Pressable
            onPress={() => dispatch({ type: "SET_LANG", lang: "pa" })}
            style={{
              backgroundColor: "#F3F4F6",
              padding: 14,
              borderRadius: 10,
          ...
          <Pressable
            onPress={() => dispatch({ type: "SET_LANG", lang: "hi" })}
            style={{
              backgroundColor: "#F3F4F6",
              padding: 14,
              borderRadius: 10,
